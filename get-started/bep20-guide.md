...
The native tokens of Bitkub Chain (BKC) are **BEP20**.

To do most things on BKC, you will need to pay gas, which comes in the form of BEP20 KUB.

You will also need the BEP20 version of any token you want to trade, stake etc. on BKC.
...
[**Binance.com**](https://github.com/changswap/chang-document/tree/255db0c7af28df2f9c1209daa5cdbd774490a666/get-started/www.binance.com) _\*\*_- You can withdraw tokens as BEP20 via your Binance account (if you have one). Bear in mind you need an account to do so.
