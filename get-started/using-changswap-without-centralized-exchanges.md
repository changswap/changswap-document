...
description: >-
  ...
  other centralized exchange to start using ChangSwap!
---

# Using ChangSwap without Centralized Exchanges

ChangSwap is a decentralized application. That means, unlike Binance or other centralized platforms, you don't need to register account to use it... you just need a crypto wallet. So how can you get crypto onto ChangSwap without using a centralized exchange?

In this tutorial, we're going to guide you through the process of using "cross-chain bridges" to transfer your assets into your Bitkub Chain wallet, and start using ChangSwap.

### **Move your assets from other blockchains to Bitkub Chain**

You can use a variety of different cross-chain bridges to transfer tokens from Ethereum or other networks, onto Bitkub Chain.

In the following tutorials, we are going to demonstrate moving USDT from a variety of different blockchains to Bitkub Chain, using three different cross-chain bridges.

{% tabs %}
{% tab title="Binance Bridge (Recommanded)" %}
Binance Bridge may be the easiest bridge to use for moving assets onto Bitkub Chain (BKC).

In the following example, we'll show you how to move USDT from **TRON** blockchain to BKC using Binance Bridge.

The process is about the same for moving from **Ethereum** to BKC.
...
4. Connect your MetaMask or Bitkub Chain wallet.
5.  Select TRX Network as "From", Bitkub Chain Network as "To". Then type in the amount of USDT you want to transfer.
...
6.  Additionally you can ask Binance Bridge to swap some KUB for you in the process of moving your USDT from TRON to BKC. This is particularly helpful when you are new to Bitkub Chain with a fresh wallet, and need some KUB for gas.
...
7. Double check the “Destination” field is showing the correct Bitkub Chain wallet address you’ve connected.
...
11. Once you complete the transaction. You should receive your fund in Bitkub Chain wallet in a few minutes. After that, you can start using ChangSwap to swap some tokens on Bitkub Chain!
...
{% tab title="AnySwap" %}
Let's try moving USDT from Polygon (MATIC) blockchain to BKC using AnySwap.
...
5.  Select USDT on MATIC mainnet as "From", and USDT on BKC mainnet as "To". Then type in the amount of USDT you want to transfer.
...
7. Additionally if you want AnySwap to deposit your USDT into another BKC address. Please use the "+ Send To" button.
...
10. Once finished. You should receive your fund in your BKC wallet. Now you can start using ChangSwap to swap some tokens on Bitkub Chain!
{% endtab %}

{% tab title="O3 Hub" %}
⚠️ **O3 Swap is in beta. Please trade at your own risk.**

Let's try using O3 Hub to moving USDT from ERC-20 blockchain to Bitkub Chain.
...
4.  Connect your MetaMask or O3 wallet for both ETH and BKC. And switch your network in MetaMask to Ethereum Mainnet.

    ![](<../.gitbook/assets/MBP3-2021.10.19-054852AM-Google Chrome\_O3swap.png>)
5.  Select ERC-20 USDT as “You pay”, and KEP-20 USDT as "You will receive". Then type in the amount of USDT you want to transfer.

    ![](<../.gitbook/assets/MBP3-2021.10.19-053358AM-Google Chrome\_O3swap.png>)
6.  Double check the “To” field is showing the correct Bitkub Chain wallet address you’ve connected.
...
10. Once finished. You should receive your funds in your BKC wallet. Now you can start using ChangSwap to swap some tokens on Bitkub Chain!
