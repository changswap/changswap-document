...
Playing the ChangSwap Lottery gives you a chance to win huge CHANG prizes! It's easy, fair, and you can enter as often as you like as long as you have the CHANG to buy a ticket.

[View smart contract](https://bkcscan.com/address/0x5aF6D33DE2ccEC94efb1bDF8f92Bd58085432d2c)

## **Specifics:**

* Lottery ticket cost for 1 ticket: \~$5 USD in CHANG.
...
‌For example, if you have the only ticket that matched three numbers in order, and the predetermined share of the prize pool for your bracket was 2000 CHANG, you'll receive the full 2000 CHANG.

‌If, however, you and three other people match three numbers in order, the 2000 CHANG would be split between the four winning tickets, meaning you would receive 500 CHANG.
