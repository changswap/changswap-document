...
Joining IFOs can be exciting and very rewarding. The [ChangSwap website’s IFO page](https://changswap.com/ifo) is an easy way to join an IFO. But some users may prefer to interact directly with smart contracts on the BkcScan website. Using BkcScan will let you see a contract's code, review its analytics and events in real-time, and find other useful information.

Currently, only MetaMask or WalletConnect wallets can interact directly with BkcScan. WalletConnect is still in beta, so for now we recommend using MetaMask.&#x20;

{% hint style="warning" %}
Interacting directly with smart contracts is not something we’d recommend to beginners. If you’d like to join an IFO without the complicated steps, we have a [How to Participate in an IFO guide](https://docs.changswap.com/get-started/ifo-guide) to help you through the process using the ChangSwap website.
{% endhint %}
...
### Create your ChangSwap profile

To take part in an IFO, you'll need a ChangSwap profile. Having a profile protects the security of the IFO and makes it fair for everyone. The small cost of a profile also helps keep the total CHANG supply down by burning a little CHANG from each profile created. To create a profile, you can follow our [How to Set Up an NFT Profile guide](https://docs.changswap.com/get-started/profile-guide).

### Get CHANG-KUB Liquidity Tokens

Once you have a profile, you will also need to provide liquidity to get some CHANG-KUB LP Tokens. These will be used to buy the tokens being offered in the IFO. To provide liquidity and get some CHANG-KUB LP Tokens, you can follow our [How to Add/Remove Liquidity guide](https://docs.changswap.com/get-started/liquidity-guide).

## Once the IFO is live

While an IFO is live, you will have 1 hour to participate. If you have prepared your CHANG-KUB LP Tokens it doesn’t take long at all to buy the new token.

### Getting the IFO’s smart contract address

You’re going to need the IFO’s smart contract address to join the IFO. You can find a link to the contract’s BkcScan page on the IFO page of the [ChangSwap website](https://changswap.com/ifo) underneath the Unlimited Sale section.
...
1\. Open a new tab and visit the [ChangSwap LP BkcScan contract page](https://bkcscan.com/address/0x0ed7e52944161450477ee417de9cd3a859b14fd0#writeContract) and make sure you’re on **Contract**, **Write Contract**.
...
5\. You’re also going to need to approve the amount of LP Tokens the contract can spend. In the value field, you’ll need to enter the amount in Wei. You can use the [BkcScan Unit Converter](https://www.bkcscan.com/unitconverter) to easily change your amount into Wei.
...
Now that you’ve approved the IFO to spend your Chang LP Tokens, you’re ready to buy into the IFO.
...
5\. A **View your transaction** button will appear. You can click the button to view your transaction on the BkcScan explorer to confirm it worked.
...
You can also check the IFO page on ChangSwap’s website to see your deposit.
...
3\. You can click **View your transaction**, or visit the ChangSwap IFO page to confirm your transaction.
...
1\. To collect your new tokens, you’ll need to visit the IFO contract page on BkcScan, and click **Contract**, then **Write Contract**.
...
4\. You can click **View your transaction** or visit the ChangSwap IFO page to confirm your tokens have been collected.
